...
def apply_sddm_screen(target_screen):
    try:
        ...
        tmp_target = f"/tmp/target_monitor"
        tmp_xsetup = f"/tmp/Xsetup"
...
"""
        ...
        cmd = f"sudo mkdir -p {SDDM_CONF_DIR} /usr/share/sddm/scripts && sudo cp {tmp_conf} {SDDM_DISPLAY_CONF} && sudo cp {tmp_target} {SDDM_CONF_DIR}/target_monitor && sudo cp {tmp_xsetup} /usr/share/sddm/scripts/Xsetup && sudo chmod 644 {SDDM_DISPLAY_CONF} {SDDM_CONF_DIR}/target_monitor && sudo chmod +x /usr/share/sddm/scripts/Xsetup"
...
if __name__ == "__main__":
    if len(sys.argv) > 2 and sys.argv[1] == "--set":
        ...
        if apply_sddm_screen(target_screen):
            print(f"SDDM login screen set to {target_screen} successfully.")
        sys.exit(0)
